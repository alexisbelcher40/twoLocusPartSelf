...
Accounting for linkage between SA loci yields several theoretical insights regarding the maintenance of SA polymorphism in hermaphroditic organisms. Overall, the reduction in the effective recombination rate due to selfing significantly expands the parameter space where balancing selection is predicted to maintain SA polymorphism beyond that of single-locus models (doubling the area under some parameter conditions). Increased selfing biases the net direction of selection towards female interests, reducing the opportunity for male-beneficial alleles to invade at a single locus (\citealt{Charlesworth1978, JordanConn2014}). However, the concomitant decrease in recombination among double heterozygotes compensates for this ``female-bias'' in selection by slowing the break-up of polymorphic allelic combinations. This allows male-beneficial alleles to invade when linked to female-benefical alleles at the other locus, thereby expanding the parameter space where balancing selection is predicted to maintain SA polymorphism. When the sex-specific fitness costs of SA alleles are partially recessive, balancing selection primarily maintains SA polymorphism due to net overdominance. This dampens the effect of reduced recombination due to selfing, particularly in populations with relatively low selfing rates. However, the net effect of high selfing rates is still a dramatic increase in the parameter space where male-beneficial alleles can invade. Regardless of the dominance conditions, the effect of reduced recombination on the maintenance of SA polymorphism in hermaphrodites is limited under weak selection ($s_f,s_m < 0.1$). If selection on individual SA loci is weak, extremely tight linkage is required for a selfing-induced reduction in effective recombination rate to significantly expand the parameter space where balancing selection is predicted to occur beyond that of single-locus models.


Although balancing selection at SA loci is least likely in highly selfing species, it may still provide a plausible mechanism for the maintenance of SA genetic variation, in addition to recurrent mutation (\citealt{JordanConn2014}), in species with intermediate to high selfing rates when SA loci are linked. The results of the two-locus model may also have bearing on the prevalence of mixed mating systems among hermaphroditic plants and animals (\citealt{JarneAuld2006, Goodwillie2005, Igic2005}). While the female-bias in selection introduced by selfing is consistent with the evolution of ``selfing syndromes'' (\citealt{Sicard2011}), the increased scope for male-beneficial alleles to invade suggests a potential explanation for the persistence of traits promoting male gamete dispersal and performance in populations with intermediate selfing rates (\citealt{Goodwillie2005, Sicard2011}). Given that SA allele frequency change is often predicted to be slow and dominanted by drift (\citealt{ConnClark2011, ConnClark2012, ConnClark2014}), the loss of male-beneficial alleles may also be slow and stochastic in partially selfing species with linked SA loci, regardless of whether mixed mating is an evolutionary stable strategy (\citealt{Goodwillie2005}).

...
Accounting for linkage between SA loci yields several theoretical insights regarding the maintenance of SA polymorphism in hermaphroditic organisms. Overall, the reduction in the effective recombination rate due to selfing significantly expands the parameter space where balancing selection is predicted to maintain SA polymorphism beyond that of single-locus models, provided (doubling the area under some parameter conditions). When the sex-specific fitness costs of SA alleles are partially recessive (i.e. there is a ``dominance reversal''), balancing selection primarily maintains SA polymorphism due to net overdominance, dampening the effect of reduced recombination in populations with relatively low selfing rates. Nevertheless, the net effect of high selfing rates is still a dramatic increase in the parameter space where SA polymorphism is maintained. Thus, although balancing selection at SA loci is least likely in highly selfing species, it may still provide a plausible mechanism, along with recurrent mutation (\citealt{JordanConn2014}), for the maintenance of SA genetic variation in species with intermediate to high selfing rates. 

The effects of linkage in the two-locus model may also have bearing on the prevalence of mixed mating systems, which are represented by a large fraction of hermaphroditic plants and animals (\citealt{JarneAuld2006, Goodwillie2005, Igic2005}). While the female-bias in the net direction of selection introduced by selfing is consistent with the evolution of ``selfing syndromes'' (\citealt{Sicard2011}), the increased scope for linked male-beneficial alleles to invade provides an another possible explanation for the persistence of traits promoting male gamete dispersal and performance in partially selfing populations (\citealt{Goodwillie2005, Sicard2011}). Given that SA allele frequency change is often predicted to be slow and dominated by drift (\citealt{ConnClark2011, ConnClark2012, ConnClark2014}), the loss of male-beneficial alleles may also be slow and stochastic in partially selfing species with linked SA loci, regardless of whether mixed mating is an evolutionary stable strategy (\citealt{Goodwillie2005}).

Regardless of the dominance conditions, the effect of reduced recombination on the maintenance of SA polymorphism in hermaphrodites is limited under weak selection ($s_f,s_m < 0.1$). If selection on individual SA loci is weak, extremely tight linkage is required for a selfing-induced reduction in effective recombination rate to significantly expand the parameter space where balancing selection is predicted to occur beyond that of single-locus models.
